...
export default function Home() {
  ...
  function getSavedData() {
    return {
      ...
      idea, result, title, learningExamples,
    };
  }
  ...
  useEffect(() => {
    ...
    customBuyerType, companion, customCompanion, location, hookSpeaker,
    customHookSpeaker, openingEmotion, theme, formulaId, versions, scriptLength,
    idea, result, title, learningExamples, syncKey,
  ]);
    ...
    <div className={`app ${dark ? "dark" : ""} scale-${uiScale} theme-${accentTheme}`}>
      ...
      <aside className={mobileOpen ? "sidebar open" : "sidebar"}>
        <div className="brand-box brand-box-v13">
          ...
          <div className="brand-copy">
            ...
            <small>Siêu Di Động · V22.1</small>
          </div>
          <button
      ...
      <main className="main">
            ...
            <>
              <section className="hero">
                <div className="hero-copy">
                  ...
                  <p>
                    V22.1 giúp Content Universe học từ những kịch bản bạn đã Copy:
        ...
        <footer className="site-copyright">
          <span>© 2026 Content Universe · Siêu Di Động</span>
          <strong>Bản quyền thuộc Nguyễn Khánh Hải — Người sáng lập Siêu Di Động</strong>
        </footer>
      </main>
