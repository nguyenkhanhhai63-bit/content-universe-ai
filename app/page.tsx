...
export default function Home() {
  ...
  useEffect(() => {
    localStorage.setItem(
      STORAGE_KEY,
      JSON.stringify({ dark, hooks, formulas, scripts, style, messages })
    );
  }, [dark, hooks, formulas, scripts, style, messages]);
            ...
            <>
              <section className="hero">
                <div className="hero-copy">
                  ...
                  <p>
                    V8 biến Content Universe thành trợ lý viết nội dung thực sự:
