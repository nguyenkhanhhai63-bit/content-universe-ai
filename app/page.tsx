...
export default function Home() {
  ...
  useEffect(() => {
    localStorage.setItem(
      STORAGE_KEY,
      JSON.stringify({ dark, uiScale, accentTheme, topics, hooks, formulas, scripts, style, messages })
    );
  }, [dark, uiScale, accentTheme, topics, hooks, formulas, scripts, style, messages]);
  ...
  return (
    <div className={`app ${dark ? "dark" : ""} scale-${uiScale} theme-${accentTheme}`}>
      <aside className={mobileOpen ? "sidebar open" : "sidebar"}>
        <div className="brand-box brand-box-v12">
          <div className="brand-logo-image">
            <img src="/sieu-di-dong-icon.png" alt="Logo Siêu Di Động" />
          </div>
          <div>
            <strong>CONTENT UNIVERSE</strong>
            <small>Siêu Di Động · V12</small>
          </div>
        </div>
              ...
              <section className="hero">
                <div className="hero-copy">
                  <div className="hero-brand-row">
                    <img src="/sieu-di-dong-logo-full.png" alt="Siêu Di Động" />
                    <span className="eyebrow">CONTENT COMMAND CENTER</span>
                  </div>
                  <h2>Một ý tưởng nhỏ.<br />Năm phiên bản đủ mạnh để chọn.</h2>
                  <p>
                    V12 biến Content Universe thành trợ lý viết nội dung thực sự:
